...
//  unsigned int getFragment_id();
  ...
  /*
   * checkGroundPlane
   * checks if the detectec object is the ground plane
   * @param[return]: if ground plane is detected return true
   */
...
protected:
  ...
  /*
   * axis of object (from pca-analysis)
   */
//  double* _axis_major;
//  double* _axis_middle;
//  double* _axis_minor;
