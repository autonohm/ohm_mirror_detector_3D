...
///*
// * pointLocationCheck
// * check, if point is located on the object plane, behind the object plane or if it is an valid scan point
// * @param[in] coords: coefficients of plane a,b,c,d (E: a*x + b*y + c*z + d = 0
// * @param[in] dist: coefficients of plane a,b,c,d (E: a*x + b*y + c*z + d = 0
// * @param[in] corners: coefficients of plane a,b,c,d (E: a*x + b*y + c*z + d = 0
// * @param[out] type: returns location
// *              0: regular scan point (in front of plane or besides the vision cone
// *              1: point on the object plane
// *              2: point behind object plane
// */
