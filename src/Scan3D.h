...
public:
   ...
   */
  scan3D(unsigned int seq, unsigned long timestamp, std::string frame_id, unsigned int fragmentid, unsigned int fragement_size, unsigned int size, double* coords_1, unsigned int* intens_1, double* coords_2, unsigned int* intens_2);
